...
var FETCH_START = 'FETCH_START'; //开始加载
var FETCH_SUCCESS = 'FETCH_SUCCESS'; //加载 成功
var FETCH_ERROR = 'FETCH_ERROR'; //加载失败
  ...
  _createClass(Panel, [{
    ...
    value: function render() {
      var _store$getState = store.getState(),
          loading = _store$getState.loading,
...
_reactDom2.default.render(_react2.default.createElement(Panel, null), document.querySelector('#root'));
